...
bot = TeleBot(token='5883942336:AAHxNV7y0PRvAKvNZ6OvoK9obCc0IkBZCh0', parse_mode='html') # создание бота
...
DEFINITOINS = {
    ...
    'тест-кейс': 'Профессиональная документация тестировщика, последовательность действий направленная на проверку какого-либо функционала, описывающая как придти к фактическому результату. Набор тест-кейсов называют тест-комплектом.'
}
